...
| MFA enforced on Tier 1 and Tier 2 | Brute Force | T1110 | Credential Access | Valid credentials alone are insufficient, attacker must also compromise the second factor |
